...
import HandleTabs from './js/tabs';
...
<Playground>
  <div className='a-tabbed'>
    <ul className='a-tabbed__list'>
      <li>
        <a href='#section1'>
          <i className='a-icon a-icon--cup a-icon--size-small a-icon--space-right a-tabbed__icon' aria-hidden='true' />
          <span>section 1</span>
        </a>
      </li>
      <li>
        <a href='#section2'>
          <i className='a-icon a-icon--calendar a-icon--size-small a-icon--space-right a-tabbed__icon' aria-hidden='true' />
          <span>section 2</span>
        </a>
      </li>
      <li>
        <a href='#section3'>
          <i className='a-icon a-icon--clock a-icon--size-small a-icon--space-right a-tabbed__icon' aria-hidden='true' />
          <span>section 3</span></a>
      </li>
    </ul>
    <section id='section1'>
